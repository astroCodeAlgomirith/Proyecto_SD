...
public long recuperar(Consumer<Transaccion> aplicar) {
    ...
    try {
        ...
        // No degradamos a estado base en silencio: servir el CSV con seq=0
        // haria que las nuevas tx reutilicen seqs ya usados y corrompan el
        // log. Fallamos ruidosamente para abortar el arranque.
...
// Drena la cola asincrona en un apagado ordenado (SIGTERM).
